...
function makeBot(){
  ...
  bot.once("spawn",()=>{game.ready();game.setHome();behavior.start();console.log("[YazoniBot] Autonomous mode active.");bot.chat("I am here.");});
  ...
  bot.on("health",()=>{if(bot.health<8)behavior?.onOwnerMessage("").catch(()=>{});});
