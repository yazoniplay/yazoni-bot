...
export const config={
  ...
  thinkMs:Math.min(num(process.env.THINK_INTERVAL_MS,8000),8000),proactiveChatMs:num(process.env.PROACTIVE_CHAT_MS,30000),maxPlanSteps:num(process.env.MAX_PLAN_STEPS,8),
